...
<body>		
		<div class="order">
			...
			<%Ordersdetails od1 = (Ordersdetails)session.getAttribute("od1"); %>
					<div class="new_add">
						<p class="p1">修改地址</p>

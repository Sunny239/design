  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom">${list.productid }</td>
        ...
        <td align="center" valign="middle" class="borderbottom"><a href="${ctx }/dorders/del?useraddress=${list.useraddress}&date=${list.date}&productId=${list.productid}&state=${list.state}" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
      </tr> 
      <%count++; %>
      </c:forEach> 
    </table></td>

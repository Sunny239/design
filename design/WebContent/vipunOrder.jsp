  ...
  <div class="cont">
   ...
   <div class="contRight">
    ...
    <c:forEach items="${list }" var="list">
     <tr>
      <td><img src="/design/images/pi7.png" width="60" height="55"></a></td>
      <td>${list.name }</td>
      <td>￥${list.price }</td>
      <td>
      <a href="${ctx }/orders/jian?productId=${list.productid}&date=${list.date}&state=${list.state}"><span class="sy_minus" id="sy_minus_gid1">-</span></a>
      ${list.count }
      <a href="${ctx }/orders/jia?productId=${list.productid}&date=${list.date}&state=${list.state}"><span class="sy_minus" id="sy_minus_gid1">+</span></a>
      </td>

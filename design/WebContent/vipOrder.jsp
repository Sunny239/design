  ...
  <div class="cont">
   <div class="contLeft" id="contLeft">
    ...
    <dl class="helpNav vipNav">
     <dt>我的主页</dt>
      <dd>
       <a href="${ctx }/orders/get?state=1" class="vipCur">已处理订单</a>
       <a href="${ctx }/orders/get1?state=0">未处理订单</a>
      </dd>
     <dt>账户设置</dt>
      <dd>
   ...
   <div class="contRight">
    ...
    <c:forEach items="${list }" var="list">
     <tr>
      ...
      <td><a href="${ctx }/orders/del1?productId=${list.productid}&date=${list.date}&state=${list.state}"><img src="/design/images/trash.gif"/></a></td>	
     </tr>
     </c:forEach>
    </table><!--vipOrder/-->
    <br />

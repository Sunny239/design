...
public class OrdersService {
	...
	public void del(int productid,String date,int state,HttpSession session){
		ordersdao.del(productid, date, state,session);
	}
	...
	public Ordersdetails xianshi(HttpSession session){
		return ordersdao.xianshi(session);
	}
	
	public void jian(int productId,String date,int state){
		ordersdao.jian(productId, date, state);
	}
	public void jia(int productId,String date,int state){
		ordersdao.jia(productId, date, state);
	}
}
